...
public class WorkspaceGraph3D extends Application {
    ...
    private double  glideTargetRX    = 0;   // target rotateX angle (always 0)
    private double  glideTargetRY    = 0;   // target rotateY angle (always 0)
    ...
    private void syncSceneGraph() {
        ...
        if (glideActive) {
            ...
            // Stop once all four values are close enough
