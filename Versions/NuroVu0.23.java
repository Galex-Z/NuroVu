...
public class WorkspaceGraph3D extends Application {
     ...
     *
     * ZOOM IS INTENTIONALLY NOT TOUCHED.
     * The camera's translateZ stays exactly where the user left it.
     * Only pan (world3D translateX/Y) and rotation are animated.
     *
     * If the node has connected edges, we compute the average edge length
     * and set the hint label — but we do NOT force a zoom level.
     * The user's scroll position is always respected.
     */
