...
public class WorkspaceGraph3D extends Application {
    ...
    public void start(Stage stage) {
        ...
        // When returning from fullscreen, explicitly restore the windowed
        // dimensions so the BorderPane has enough room to show both the
        // 3D viewport and the sidebar.  Without this, JavaFX may restore
        // to a cached minimum size that hides the right panel.
